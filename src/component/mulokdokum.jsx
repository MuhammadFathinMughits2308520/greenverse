...
const MuatanLokalDokum = () => {
  ...
  return (
    <section 
      className="muatan-lokal-gallery" 
      id="muatan-lokal-dokumentasi" 
      ref={galleryRef}
    >
      <div className="muatan-lokal-container">
        {/* Header */}
        <h3 className={`gallery-title ${isVisible ? 'visible' : ''}`}>
          Dokumentasi Kegiatan
        </h3>
        <p className={`gallery-subtitle ${isVisible ? 'visible' : ''}`}>
                  ...
                  {image.source && image.sourceUrl && (
                    <p className="image-source">
                      <a
                        ...
                        aria-label={`Buka sumber: ${image.source}`}
                      >
                        Sumber: {image.source}
                      </a>
                    </p>
