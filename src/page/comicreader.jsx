...
// ComicReader.jsx - Updated dengan Tutorial Button
import React, { useEffect, useState, useRef, useCallback } from "react";
import { useNavigate } from 'react-router-dom';
import { useDarkMode } from '../context/DarkModeContext';
import LogoutButton from "../component/logoutbutton";
...
export default function ComicReader({ comic = "sample", episode = "1" }) {
  ...
  return (
    <div ref={containerRef} className="comic-reader" onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd}>
      ...
      {showChatbot && (
        <div className="chatbot-floating" role="button" tabIndex={0} onClick={() => navigate('/ecombot')}>
          <img src="/item/chatbot-icon.svg" alt="Chatbot" />
        </div>
      )}
